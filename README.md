...
2.Unnecessary attributes for analysis have been removed.<br>
분석에 불필요한 특성을 제거했습니다.<br>
3. Degree of Interest of Region is quantificated for Regression.(Pre-processing is not included)<br>
